...
@Subselect(
        "SELECT a.application_id, a.user_id, " +
                ...
                "p.payment_id as payment_id, p.is_confirmed as payment_is_confirmed, p.is_refunded as payment_is_refunded, p.payment_key, p.program_price, p.create_date as payment_create_date, " +
...
public class VWApplication extends BaseTimeEntity {
    ...
    private Boolean paymentIsConfirmed;
    private Boolean paymentIsRefunded;
