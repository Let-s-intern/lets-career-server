...
@Component
@StepScope
public class ReportLastRemindNotificationTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        if(!Objects.isNull(reportApplication) && !Objects.isNull(notificationVo)) {
            ...
            String templateCode = notificationVo.isFeedbackApplied() ? "feedback_last_remind" : "report_last_remind";
